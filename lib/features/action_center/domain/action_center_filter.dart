...
class ActionCenterListQuery {
  ...
  ActionCenterListQuery copyWith({String? search, ActionCenterFilter? filter}) {
...
bool actionCenterItemMatchesFilter(
  ActionCenterItem item,
  ActionCenterFilter filter,
) {
  return switch (filter) {
    ActionCenterFilter.all => true,
    ActionCenterFilter.registration =>
      item.type == ActionCenterItemType.registration,
    ...
    ActionCenterFilter.systemHealth =>
      item.type == ActionCenterItemType.systemHealth,
    ActionCenterFilter.security => item.type == ActionCenterItemType.security,
    ActionCenterFilter.billing =>
      item.type == ActionCenterItemType.billing ||
