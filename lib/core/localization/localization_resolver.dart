...
String resolveLocalizationKey(BuildContext context, String key) {
  ...
  return switch (key) {
    ...
    LocalizationKeys.authServerUnreachable => l10n.authServerUnreachable,
    LocalizationKeys.authRetryConnection => l10n.authRetryConnection,
...
String resolveSystemHealthKey(
  ...
  return switch (key) {
    ...
    'systemHealthServiceTapDetails' => l10n.systemHealthServiceTapDetails,
    'systemHealthDetailService' => l10n.systemHealthDetailService,
    'systemHealthDetailCurrentState' => l10n.systemHealthDetailCurrentState,
    'systemHealthDetailLastChecked' => l10n.systemHealthDetailLastChecked,
    'systemHealthDetailLastSuccess' => l10n.systemHealthDetailLastSuccess,
    'systemHealthDetailLastError' => l10n.systemHealthDetailLastError,
    'systemHealthDetailAffectedPlatform' =>
      l10n.systemHealthDetailAffectedPlatform,
    'systemHealthDetailRecommendedAction' =>
      l10n.systemHealthDetailRecommendedAction,
...
String resolveSecurityKey(
  ...
  return switch (key) {
    ...
    'securityEventFieldResult' => l10n.securityEventFieldResult,
    'securityEventFieldReason' => l10n.securityEventFieldReason,
    'securityEventFieldAccount' => l10n.securityEventFieldAccount,
    'securityEventFieldPlatform' => l10n.securityEventFieldPlatform,
    'securityEventFieldDevice' => l10n.securityEventFieldDevice,
    'securityEventFieldIpFingerprint' => l10n.securityEventFieldIpFingerprint,
    'securityEventReasonLabel' => l10n.securityEventReasonLabel(
      params['reason'] ?? '',
    ),
    ...
    'securityEventSeverityError' => l10n.securityEventSeverityError,
...
String resolveDriverAccessKey(BuildContext context, String key) {
  ...
  return switch (key) {
    ...
    'driverAccessNoPushToken' => l10n.driverAccessNoPushToken,
    ...
    'driverAccessPendingRejectCancel' => l10n.driverAccessPendingRejectCancel,
    'driverAccessPendingRejectConfirm' => l10n.driverAccessPendingRejectConfirm,
    'driverAccessPendingRejectSuccess' => l10n.driverAccessPendingRejectSuccess,
...
String resolveQrCodesKey(BuildContext context, String key) {
  final l10n = AppLocalizations.of(context);
  return switch (key) {
    'qrCodesTitle' => l10n.qrCodesTitle,
    'qrCodesGenerateAction' => l10n.qrCodesGenerateAction,
    'qrCodesUserTitle' => l10n.qrCodesUserTitle,
    'qrCodesDriverTitle' => l10n.qrCodesDriverTitle,
    'qrCodesCompanyTitle' => l10n.qrCodesCompanyTitle,
    'qrCodesPurposeLabel' => l10n.qrCodesPurposeLabel,
    'qrCodesPurposeCompanyIdentity' => l10n.qrCodesPurposeCompanyIdentity,
    'qrCodesPurposeUserIdentity' => l10n.qrCodesPurposeUserIdentity,
    'qrCodesPurposeDriverIdentity' => l10n.qrCodesPurposeDriverIdentity,
    'qrCodesIdentityHint' => l10n.qrCodesIdentityHint,
    'qrCodesInviteHint' => l10n.qrCodesInviteHint,
    'qrCodesPurposeUserInvite' => l10n.qrCodesPurposeUserInvite,
    'qrCodesPurposeUserActivation' => l10n.qrCodesPurposeUserActivation,
    'qrCodesPurposePasswordSetup' => l10n.qrCodesPurposePasswordSetup,
    'qrCodesPurposeDriverAppLink' => l10n.qrCodesPurposeDriverAppLink,
    'qrCodesPurposeDriverProfile' => l10n.qrCodesPurposeDriverProfile,
    'qrCodesPurposeCompanyProfile' => l10n.qrCodesPurposeCompanyProfile,
    'qrCodesPurposeCompanyInvite' => l10n.qrCodesPurposeCompanyInvite,
    'qrCodesPurposeCompanyPortalLogin' => l10n.qrCodesPurposeCompanyPortalLogin,
    'qrCodesPurposeCompanyOnboarding' => l10n.qrCodesPurposeCompanyOnboarding,
    'qrCodesPurposeSupportReference' => l10n.qrCodesPurposeSupportReference,
    'qrCodesPurposeInternalAdmin' => l10n.qrCodesPurposeInternalAdmin,
    'qrCodesPurposePublicCompany' => l10n.qrCodesPurposePublicCompany,
    'qrCodesPurposePublicDriver' => l10n.qrCodesPurposePublicDriver,
    'qrCodesExpiresLabel' => l10n.qrCodesExpiresLabel,
    'qrCodesSingleUse' => l10n.qrCodesSingleUse,
    'qrCodesMultiUse' => l10n.qrCodesMultiUse,
    'qrCodesUsageLimit' => l10n.qrCodesUsageLimit,
    'qrCodesStatusActive' => l10n.qrCodesStatusActive,
    'qrCodesStatusExpired' => l10n.qrCodesStatusExpired,
    'qrCodesStatusConsumed' => l10n.qrCodesStatusConsumed,
    'qrCodesStatusRevoked' => l10n.qrCodesStatusRevoked,
    'qrCodesShare' => l10n.qrCodesShare,
    'qrCodesSave' => l10n.qrCodesSave,
    'qrCodesCopyLink' => l10n.qrCodesCopyLink,
    'qrCodesRegenerate' => l10n.qrCodesRegenerate,
    'qrCodesRevoke' => l10n.qrCodesRevoke,
    'qrCodesHistory' => l10n.qrCodesHistory,
    'qrCodesSecurityWarning' => l10n.qrCodesSecurityWarning,
    'qrCodesInvalid' => l10n.qrCodesInvalid,
    'qrCodesExpired' => l10n.qrCodesExpired,
    'qrCodesConsumed' => l10n.qrCodesConsumed,
    'qrCodesAccessDenied' => l10n.qrCodesAccessDenied,
    'qrCodesStagingBadge' => l10n.qrCodesStagingBadge,
    'qrCodesProductionBadge' => l10n.qrCodesProductionBadge,
    'qrCodesCreateSuccess' => l10n.qrCodesCreateSuccess,
    'qrCodesRevokeSuccess' => l10n.qrCodesRevokeSuccess,
    'qrCodesRegenerateSuccess' => l10n.qrCodesRegenerateSuccess,
    'qrCodesLinkCopied' => l10n.qrCodesLinkCopied,
    'qrCodesEmptyHistory' => l10n.qrCodesEmptyHistory,
    'qrCodesCreate' => l10n.qrCodesCreate,
    'qrCodesClose' => l10n.qrCodesClose,
    'qrCodesTargetSummary' => l10n.qrCodesTargetSummary,
    'qrCodesUsedCount' => l10n.qrCodesUsedCount,
    'qrCodesIdentityCard' => l10n.qrCodesIdentityCard,
    'qrCodesShareCard' => l10n.qrCodesShareCard,
    'qrCodesSaveCard' => l10n.qrCodesSaveCard,
    'qrCodesCardSaved' => l10n.qrCodesCardSaved,
    'qrCodesOpenQr' => l10n.qrCodesOpenQr,
    'qrCodesQrSaved' => l10n.qrCodesQrSaved,
    'qrCodesAttachPhoto' => l10n.qrCodesAttachPhoto,
    'qrCodesChangePhoto' => l10n.qrCodesChangePhoto,
    'qrCodesRemovePhoto' => l10n.qrCodesRemovePhoto,
    'qrCodesCardBrandDriver' => l10n.qrCodesCardBrandDriver,
    'qrCodesCardBrandCompany' => l10n.qrCodesCardBrandCompany,
    'qrCodesCardBrandUser' => l10n.qrCodesCardBrandUser,
    'qrCodesCardFieldName' => l10n.qrCodesCardFieldName,
    'qrCodesCardFieldId' => l10n.qrCodesCardFieldId,
    'qrCodesCardFieldRole' => l10n.qrCodesCardFieldRole,
    'qrCodesCardFieldPurpose' => l10n.qrCodesCardFieldPurpose,
    'qrCodesCardFieldDetail' => l10n.qrCodesCardFieldDetail,
